                ...
                <div class="card-header">
                  <div class="row">
                    ...
                    <div class="col" align="right">
                      <a  href="{{route ('tahunjurfti.excel')}}" class="btn btn-success">Export to Excel</a>
                    </div>
                  </div>
                </div>
                <div class="card-body">
                    ...
                    {!! Form::open(['url' => 'tahunjurfti','class' => 'ajax']) !!}
                    <div class="row">
                      <div class="col form-group">
                          {!! Form::selectYear('year', 2000, 2020,null,['class' => 'form-control','placeholder'=>'Pilih Tahun ...']) !!}
                      </div>
                      <div class="col form-group">
